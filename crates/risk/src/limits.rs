...
impl Default for PositionLimits {
    fn default() -> Self {
        Self {
            ...
            max_position_per_asset: 2_000_000_000, // 2000 shares
            // ~$5000 max gross position
            max_gross_position: 10_000_000_000, // 10k shares
            // ~$100 max single order
            max_order_size: 200_000_000, // 200 shares
            // ~$1 min order
            min_order_size: 2_000_000, // 2 shares
            // ~$10000 daily volume limit
            max_daily_volume: 20_000_000_000, // 20k shares
